...
public class FuncionarioServiceImpl implements FuncionarioService {
	...
	public void popularTabelaInicial() {
		repositorio.saveAll(List.of(
				new Funcionario(null, "Luiz", 1, new BigDecimal(1500), LocalDate.now()),
				new Funcionario(null, "João", 1, new BigDecimal(1200), LocalDate.now()),
				new Funcionario(null, "Mário", 1, new BigDecimal(1300), LocalDate.now()),
				new Funcionario(null, "Fulano", 1, new BigDecimal(800), LocalDate.now()),
				new Funcionario(null, "Sicrano", 1, new BigDecimal(3000), LocalDate.now()),
				new Funcionario(null, "Beltrano", 1, new BigDecimal(1200), LocalDate.now()),
				new Funcionario(null, "Patrick", 1, new BigDecimal(3500), LocalDate.now())
			)
		);
